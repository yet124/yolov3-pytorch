...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/coco1cls.data', help='*.data path')
    ...
    opt.save_json = opt.save_json or any([x in opt.data for x in ['coco.data', 'coco1cls.data', 'coco2017.data']])
    print(opt)
